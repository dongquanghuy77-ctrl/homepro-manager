...
export const WORKSPACES: WorkspaceConfig[] = [
  ...
  },
  {
    ...
    routes: ['/pwr'],
    navItems: [
      { id: 'pwr-grp',            label: 'CHÍNH VIỆC',         icon: '',             href: '#',                       sprint: 1, isGroupHeader: true },
      { id: 'pwr-today',          label: 'Daily Focus',        icon: 'Sunrise',      href: '/pwr/focus',              sprint: 2 },
      ...
      { id: 'pwr-manager',        label: 'Bảng Điều Hành',    icon: 'LayoutDashboard', href: '/pwr/manager',           sprint: 1, managerOnly: true },
      { id: 'pwr-dispatch',       label: 'Điều Phối (Kanban)', icon: 'GripVertical',   href: '/pwr/dispatch',          sprint: 1, managerOnly: true },
      { id: 'pwr-workers',        label: 'Quản Lý Thợ',       icon: 'Users',           href: '/pwr/workers',           sprint: 1, managerOnly: true },
