...
"""
import os
os.makedirs("src/app/api/pwr/tasks/bulk-action", exist_ok=True)
with open("src/app/api/pwr/tasks/bulk-action/route.ts", "w", encoding="utf-8") as f:
    f.write(api_code)

print("Created Bulk Action API")