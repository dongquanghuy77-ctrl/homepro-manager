/**
 * Write PHASE1-RECONCILIATION.md to docs/projects/BAO-MINH-CMT8/
 * Must be run via: node scripts/bao-minh-write-reconciliation-md.js
 */
const fs = require('fs');
const path = require('path');

const OUT = 'docs/projects/BAO-MINH-CMT8/PHASE1-RECONCILIATION.md';

const md = `# PHASE 1 — DATA RECONCILIATION REPORT
