...
os.makedirs("src/app/api/pwr/tasks/[id]/scrap", exist_ok=True)
with open("src/app/api/pwr/tasks/[id]/scrap/route.ts", "w", encoding="utf-8") as f:
    f.write(api_code)

print("Created Scrap API")