...
import os
os.makedirs("src/components/pwr/tasks", exist_ok=True)
with open("src/components/pwr/tasks/PwrRejectModal.tsx", "w", encoding="utf-8") as f:
    f.write(ui_code)

print("Created Reject Modal UI")