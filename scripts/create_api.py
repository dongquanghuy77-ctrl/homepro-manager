...
# Create directories
os.makedirs("src/app/api/pwr/ingestion/parse", exist_ok=True)
os.makedirs("src/app/pwr/ingestion", exist_ok=True)
os.makedirs("src/components/pwr/ingestion", exist_ok=True)

api_code = """import * as xlsx from 'xlsx';
...
with open("src/app/api/pwr/ingestion/parse/route.ts", "w", encoding="utf-8") as f:
    f.write(api_code)
