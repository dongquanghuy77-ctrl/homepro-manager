...
async function migrateUAT() {
  ...
  console.log('[UAT] Connected to UAT database.');
  ...
  try {
    ...
    console.log('[OK] Applied surgical migration to UAT database.');
  } catch (err: any) {
...
migrateUAT().catch(console.error);
